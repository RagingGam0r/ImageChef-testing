...
class CodeGenerator {
    ...
    generateStartCode(language) {
        ...
        let printmsgs = [
            // Welcome / Start
            `${language[0].toUpperCase() + language.slice(1)} code generated by ImageChef (https://example.com)`, // ${language[0].toUpperCase() + language.slice(1)} == Capitalize first letter of language "python" -> "Python"
            "ImageChef was created by @RagingGam0r on GitHub (https://github.com/RagingGam0r)",
            "ImageChef (https://example.com) is a free and open source project, please consider using it to make your own image processing projects!",
        ]
        if (language == "python") {
            code += "# Python code generated by ImageChef (https://example.com)\n";
            ...
            code += "// Javascript code generated by ImageChef (https://example.com)\n";
            for (let msg of printmsgs) {
    ...
    generateEndCode(language, variables, breakpoints) {
        ...
        let printmsgs = [
            // End / Goodbye
            "Thank you for using ImageChef (https://example.com)|(https://github.com/RagingGam0r)!"
        ]
        if (language == "python") {
            variablePrefix = "";
            cvPrefix = "cv2.";

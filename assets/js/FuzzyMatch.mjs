// This code is ripped from cyberchef FuzzyMatch.mjs --> https://github.com/gchq/CyberChef/blob/a895d1d82a2f92d440a0c5eca2bc7c898107b737/src/core/lib/FuzzyMatch.mjs
// I have no clue what this is doing, but it works, only removed certain parts that I don't need
...
function fuzzyMatchRecursive(
    ...
    while (patternCurIndex < pattern.length && strCurrIndex < str.length) {
        ...
        if (
            ...
            const [matched, recursiveScore, recursiveMatches2] = fuzzyMatchRecursive(
                pattern,
                str,
                patternCurIndex,
                strCurrIndex + 1,
            ...
            if (matched) {
                ...
                if (!recursiveMatch || recursiveScore > bestRecursiveScore) {
                    bestRecursiveMatches = [...recursiveMatches2];
